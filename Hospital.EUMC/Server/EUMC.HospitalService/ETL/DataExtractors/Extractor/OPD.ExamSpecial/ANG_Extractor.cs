...
{
  internal class ANG_Extractor : DataExtractor<ANG_PT_DTO>
  {
    public ANG_Extractor(IHospitalMemberOwner owner) : base(owner, DATA_ID.ANG) { }
    protected override List<ANG_PT_DTO> query() => this.Repository.ANG_PT();
